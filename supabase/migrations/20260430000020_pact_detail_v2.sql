-- =====================================================================
-- Sprint 4 chunk 4 · Migration 0024
-- sf_get_pact_detail extendida al modelo v2.0
-- =====================================================================
-- Añade al payload:
--   * Pact: model_version, deposit_required_pct, deposit_current_cents,
--           budget_consumed_cents, certification_frequency_text
--   * Milestones: version, previous_version_id,
--                 invoice_number, invoice_storage_path, invoice_sha256, invoice_size_bytes,
--                 detailed_doc_storage_path, detailed_doc_sha256, detailed_doc_mime_type, detailed_doc_size_bytes
--   * Nueva lista: 'addendums'  → todos los anexos del pacto
--   * Nueva lista: 'deposit_movements'  → movimientos del depósito (append-only)
--
-- Retrocompatible: los pacts v1 siguen funcionando — los campos v2 simplemente
-- vienen NULL/0 y el frontend los oculta.
-- =====================================================================
...
COMMENT ON FUNCTION public.sf_get_pact_detail IS
  'Sprint 4 · Detalle completo del pacto con campos v2.0 (depósito, anexos, '
  'movimientos). Retrocompatible con pacts v1 (campos v2 vienen NULL/0).';
